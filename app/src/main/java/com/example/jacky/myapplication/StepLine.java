...
public class StepLine extends View {
    ...
    public StepLine(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public StepLine(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void setTopName(@ArrayRes int resIdopName) {
        mTopName = getStringArray(resIdopName);
        invalidate();
    }

    @NonNull
    private String[] getStringArray(@ArrayRes int resIdopName) {
    ...
    public void setBottomDescription(@ArrayRes int resIdottomDescription) {
